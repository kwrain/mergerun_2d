...
namespace FAIRSTUDIOS.Tools
{
  public enum EaseType{
	...
	public class EaseManager {
		...
		public static float LerpEaseType(float start, float end, float t, EaseType type = EaseType.linear)
    {
			switch (type){
    ...
    public static float ValueEaseType(float from, float to, float t, EaseType type = EaseType.linear)
    {
      float factor = LerpEaseType(0, 1, t, type);
