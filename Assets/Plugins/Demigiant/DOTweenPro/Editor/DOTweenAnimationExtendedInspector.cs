...
{
    [CustomEditor(typeof(DOTweenAnimationExtended), true)]
    public class DOTweenAnimationExtendedInspector : ABSAnimationInspector
    {
        enum FadeTargetType
        {
            CanvasGroup,
        ...
        static readonly Dictionary<DOTweenAnimationExtended.AnimationType, Type[]> _Tk2dAnimationTypeToComponent = new Dictionary<DOTweenAnimationExtended.AnimationType, Type[]>() {
            { DOTweenAnimationExtended.AnimationType.Scale, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { DOTweenAnimationExtended.AnimationType.Color, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { DOTweenAnimationExtended.AnimationType.Fade, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { DOTweenAnimationExtended.AnimationType.Text, new[] { typeof(tk2dTextMesh) } }
        };
#endif
#if false // TEXTMESHPRO_MARKER
        static readonly Dictionary<DOTweenAnimationExtended.AnimationType, Type[]> _TMPAnimationTypeToComponent = new Dictionary<DOTweenAnimationExtended.AnimationType, Type[]>() {
            { DOTweenAnimationExtended.AnimationType.Color, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { DOTweenAnimationExtended.AnimationType.Fade, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { DOTweenAnimationExtended.AnimationType.Text, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } }
        };
#endif
...
#pragma warning restore 414
        ...
        void OnEnable()
        {
            _src = target as DOTweenAnimationExtended;
...
//                _src.animationType = (DOTweenAnimationExtended.AnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
                ...
                _src.comment = EditorGUILayout.TextField("Comment", _src.comment);
                _src.whenStopped = (DOTweenAnimationExtended.WhenStopped)EditorGUILayout.EnumPopup("Stopped", _src.whenStopped);
                _src.startValueApplyOnCreate = EditorGUILayout.Toggle("StartValue Apply On Create", _src.startValueApplyOnCreate, new GUIStyle(GUI.skin.toggle).Clone(11));
            ...
            if (_Tk2dAnimationTypeToComponent.ContainsKey(_src.animationType)) {
                foreach (Type t in _Tk2dAnimationTypeToComponent[_src.animationType]) {
                    ...
                    if (srcTarget != null) {
                        ...
                        _src.targetType = DOTweenAnimationExtended.TypeToDOTargetType(t);
                        return true;
                    }
                }
            }
        ...
        {
            GUILayout.BeginHorizontal();
            GUILayout.Label("FROM", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
            _src.fromToValueFloat = EditorGUILayout.FloatField(_src.fromToValueFloat);
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUILayout.Label("TO", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
        ...
        void GUIEndValueColor()
        {
            ...
            GUILayout.Label("FROM", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
            _src.fromToValueColor = EditorGUILayout.ColorField(_src.fromToValueColor);
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUILayout.Label("TO", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
        ...
        void GUIEndValueV3(GameObject targetGO, bool optionalTransform = false)
        {
            ...
            GUILayout.Label("FROM", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
            if (_src.useTargetAsFromV3)
            {
                Transform prevT = _src.fromToValueTransform;
                _src.fromToValueTransform = EditorGUILayout.ObjectField(_src.fromToValueTransform, typeof(Transform), true) as Transform;
                if (_src.fromToValueTransform != prevT && _src.fromToValueTransform != null) {
#if true // UI_MARKER
                    ...
                    if (targetGO.GetComponent<RectTransform>() != null) {
                        if (_src.fromToValueTransform.GetComponent<RectTransform>() == null) {
                            EditorUtility.DisplayDialog("DOTween Pro", "For Unity UI elements, the target must also be a UI element", "Ok");
                            _src.fromToValueTransform = null;
                        }
                    } else if (_src.fromToValueTransform.GetComponent<RectTransform>() != null) {
            ...
            {
                _src.fromToValueV3 = EditorGUILayout.Vector3Field("", _src.fromToValueV3, GUILayout.Height(16));
            }
            if (optionalTransform) 
            {
                if (GUILayout.Button(_src.useTargetAsFromV3 ? "target" : "value", EditorGUIUtils.sideBtStyle, GUILayout.Width(44))) _src.useTargetAsFromV3 = !_src.useTargetAsFromV3;
            }
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUILayout.Label("TO", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
        ...
        void GUIEndValueV2()
        {
            ...
            GUILayout.Label("FROM", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
            _src.fromToValueV2 = EditorGUILayout.Vector2Field("", _src.fromToValueV2, GUILayout.Height(16));
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUILayout.Label("TO", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
        ...
        void GUIEndValueString()
        {
            ...
            GUILayout.Label("FROM", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
            _src.fromToValueString = EditorGUILayout.TextArea(_src.fromToValueString, EditorGUIUtils.wordWrapTextArea);
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUILayout.Label("TO", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
        ...
        void GUIEndValueRect()
        {
            ...
            GUILayout.Label("FROM", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
            _src.fromToValueRect = EditorGUILayout.RectField(_src.fromToValueRect);
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUILayout.Label("TO", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            GUILayout.Space(19);
