...
/**
* VmSetInteractableEditor.cs
* 작성자 : doseon@fairsutdios.kr (LEE DO SEON)
* 작성일 : 2022년 11월 30일 오후 8시 40분
*/

[CustomEditor(typeof(VmSetInteractable), true)]
[CanEditMultipleObjects]
public class VmSetInteractableEditor : VmEditor
{
  private PropertyInfoBase<VmSetInteractable.Param>[] m_pInfos;
  protected override void DrawCustom()
  {
    base.DrawCustom();
    var vmSetActive = serializedObject.targetObject as VmSetInteractable;
    if (m_pInfos == null)
    {
      ...
      m_pInfos = value as PropertyInfoBase<VmSetInteractable.Param>[];
    }
